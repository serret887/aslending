          ...
          <div className="flex flex-col gap-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                disabled={loading}
                className="w-full h-11 text-base bg-black hover:bg-black/90 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
            ...
            <div className="text-center">
              ...
              <a href="/auth/login" className="text-sm font-medium text-[#E31837] hover:underline">
                {t('login')}
              </a>
            </div>
          </div>
